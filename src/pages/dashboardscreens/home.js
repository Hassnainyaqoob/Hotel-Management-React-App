    ...
    <>
      <div>
        ...
        <Stack >
          ...
          {/* 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 */}
          ...
          <Stack direction="row" sx={{ textAlign: "center", marginLeft: 67, marginBottom: 7 }}>


            <div id="knasnskn" style={{ backgroundColor: "orange", width: 70, borderRadius: "70%", height: 67 }}>

              <a href="#"><NavigationIcon sx={{ color: "black", fontSize: 44, marginTop: 1 }} /></a>
            </div>
